(function (global, factory) {
  ...
  (global = global || self, global.AsciidoctorDocBook = factory());
      ...
      (function($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$convert_document', $DocBook5Converter_convert_document$2 = function $$convert_document(node) {
          ...
          if ((root_tag_name = node.$doctype())['$==']("manpage")) {
            root_tag_name = "refentry";}        result['$<<']("" + "<" + (root_tag_name) + " xmlns=\"http://docbook.org/ns/docbook\" xmlns:xl=\"http://www.w3.org/1999/xlink\" version=\"5.0\"" + (lang_attribute) + (self.$common_attributes(node.$id())) + ">");
          if ($truthy(node.$noheader())) ; else {
            result['$<<'](self.$document_info_tag(node));
          }        if ($truthy((docinfo_content = node.$docinfo("header"))['$empty?']())) ; else {
            result['$<<'](docinfo_content);
          }        if ($truthy(node['$blocks?']())) {
            result['$<<'](node.$content());}        if ($truthy((docinfo_content = node.$docinfo("footer"))['$empty?']())) ; else {
            result['$<<'](docinfo_content);
        ...
        Opal.def(self, '$convert_colist', $DocBook5Converter_convert_colist$5 = function $$convert_colist(node) {
          ...
          if ($truthy(node['$title?']())) {
            result['$<<']("" + "<title>" + (node.$title()) + "</title>");}        $send(node.$items(), 'each', [], ($$6 = function(item){var self = $$6.$$s || this;
            ...
            if ($truthy(item['$blocks?']())) {
              result['$<<'](item.$content());}          return result['$<<']("</callout>");}, $$6.$$s = self, $$6.$$arity = 1, $$6));
          result['$<<']("</calloutlist>");
          return result.$join($$($nesting, 'LF'));
          ...
          if (node.$style()['$==']("horizontal")) {
            ...
            $send(node.$items(), 'each', [], ($$8 = function(terms, dd){var self = $$8.$$s || this, $$9;
              ...
              if ($truthy(dd)) {
                ...
                if ($truthy(dd['$text?']())) {
                  result['$<<']("" + "<simpara>" + (dd.$text()) + "</simpara>");}              if ($truthy(dd['$blocks?']())) {
                  result['$<<'](dd.$content());}}            return result['$<<']("" + "</entry>\n" + "</row>");}, $$8.$$s = self, $$8.$$arity = 2, $$8));
            result['$<<']("" + "</tbody>\n" + "</tgroup>\n" + "</" + (tag_name) + ">");
          } else {
            ...
            if ($truthy(list_tag)) {
              ...
              if ($truthy(node['$title?']())) {
                result['$<<']("" + "<title>" + (node.$title()) + "</title>");}}          $send(node.$items(), 'each', [], ($$10 = function(terms, dd){var self = $$10.$$s || this, $$11;
              ...
              if ($truthy(label_tag)) {
                result['$<<']("" + "<" + (label_tag) + ">");}            $send(terms, 'each', [], ($$11 = function(dt){var self = $$11.$$s || this;
              ...
              if ($truthy(label_tag)) {
                result['$<<']("" + "</" + (label_tag) + ">");}            result['$<<']("" + "<" + (item_tag) + ">");
              if ($truthy(dd)) {
                
                if ($truthy(dd['$text?']())) {
                  result['$<<']("" + "<simpara>" + (dd.$text()) + "</simpara>");}              if ($truthy(dd['$blocks?']())) {
                  result['$<<'](dd.$content());}}            result['$<<']("" + "</" + (item_tag) + ">");
              return result['$<<']("" + "</" + (entry_tag) + ">");}, $$10.$$s = self, $$10.$$arity = 2, $$10));
            if ($truthy(list_tag)) {
              result['$<<']("" + "</" + (list_tag) + ">");}        }        return result.$join($$($nesting, 'LF'));
          ...
          if (node.$style()['$==']("source")) {
            ...
            if ($truthy((attrs = node.$attributes())['$key?']("linenums"))) {
              ...
              wrapped_content = "" + "<programlisting" + ((function() {if ($truthy(informal)) {
                ...
                return ""
              } })()) + " language=\"" + (attrs['$[]']("language")) + "\"" + (numbering_attrs) + ">" + (node.$content()) + "</programlisting>";
            } else {
              wrapped_content = "" + "<screen" + ((function() {if ($truthy(informal)) {
                return common_attrs
              } else {
                return ""
              } })()) + (numbering_attrs) + ">" + (node.$content()) + "</screen>";
            }        } else {
            wrapped_content = "" + "<screen" + ((function() {if ($truthy(informal)) {
              return common_attrs
            } else {
        ...
        Opal.def(self, '$convert_olist', $DocBook5Converter_convert_olist$18 = function $$convert_olist(node) {
          ...
          if ($truthy(node['$title?']())) {
            result['$<<']("" + "<title>" + (node.$title()) + "</title>");}        $send(node.$items(), 'each', [], ($$19 = function(item){var self = $$19.$$s || this;
            ...
            if ($truthy(item['$blocks?']())) {
              result['$<<'](item.$content());}          return result['$<<']("</listitem>");}, $$19.$$s = self, $$19.$$arity = 1, $$19));
          result['$<<']("</orderedlist>");
          return result.$join($$($nesting, 'LF'));
        ...
        Opal.def(self, '$convert_table', $DocBook5Converter_convert_table$28 = function $$convert_table(node) {
          ...
          if ((frame = node.$attr("frame", "all", "table-frame"))['$==']("ends")) {
            frame = "topbot";}        grid = node.$attr("grid", nil, "table-grid");
          result['$<<']("" + "<" + ((tag_name = (function() {if ($truthy(node['$title?']())) {
            return "table"
          } else {
            return "informaltable"
          } })())) + (self.$common_attributes(node.$id(), node.$role(), node.$reftext())) + (pgwide_attribute) + " frame=\"" + (frame) + "\" rowsep=\"" + ((function() {if ($truthy(["none", "cols"]['$include?'](grid))) {
            return 0
          } else {
            return 1
          } })()) + "\" colsep=\"" + ((function() {if ($truthy(["none", "rows"]['$include?'](grid))) {
            return 0
          } else {
            return 1
          } })()) + "\"" + ((function() {if ($truthy(node['$attr?']("orientation", "landscape", "table-orientation"))) {
            return " orient=\"land\""
          } else {
            return ""
          } })()) + ">");
          if ($truthy(node['$option?']("unbreakable"))) {
            ...
            result['$<<']("<?dbfo keep-together=\"auto\"?>");}        if (tag_name['$==']("table")) {
            result['$<<']("" + "<title>" + (node.$title()) + "</title>");}        col_width_key = (function() {if ($truthy((width = (function() {if ($truthy(node['$attr?']("width"))) {
          ...
          $send(node.$rows().$to_h(), 'each', [], ($$31 = function(tsec, rows){var self = $$31.$$s || this, $$32;
            ...
            if (rows == null) {
              ...
              return nil;}          if (tsec['$==']("body")) {
              has_body = true;}          result['$<<']("" + "<t" + (tsec) + ">");
        ...
        Opal.def(self, '$convert_ulist', $DocBook5Converter_convert_ulist$34 = function $$convert_ulist(node) {
          ...
          if (node.$style()['$==']("bibliography")) {
            ...
            if ($truthy(node['$title?']())) {
              result['$<<']("" + "<title>" + (node.$title()) + "</title>");}          $send(node.$items(), 'each', [], ($$35 = function(item){var self = $$35.$$s || this;
              ...
              if ($truthy(item['$blocks?']())) {
                result['$<<'](item.$content());}            return result['$<<']("</bibliomixed>");}, $$35.$$s = self, $$35.$$arity = 1, $$35));
            result['$<<']("</bibliodiv>");
          } else {
            ...
            if ($truthy(node['$title?']())) {
              result['$<<']("" + "<title>" + (node.$title()) + "</title>");}          $send(node.$items(), 'each', [], ($$36 = function(item){var self = $$36.$$s || this, $a, text_marker = nil;
              ...
              if ($truthy(item['$blocks?']())) {
                result['$<<'](item.$content());}            return result['$<<']("</listitem>");}, $$36.$$s = self, $$36.$$arity = 1, $$36));
            result['$<<']("</itemizedlist>");
          }        return result.$join($$($nesting, 'LF'));
        ...
        Opal.def(self, '$convert_inline_image', $DocBook5Converter_convert_inline_image$44 = function $$convert_inline_image(node) {
          var width_attribute = nil, depth_attribute = nil;
        ...
        Opal.def(self, '$common_attributes', $DocBook5Converter_common_attributes$50 = function $$common_attributes(id, role, reftext) {
          ...
          if (reftext == null) {
            ...
            if ($truthy(($truthy($a = reftext['$include?']("<")) ? (reftext = reftext.$gsub($$($nesting, 'XmlSanitizeRx'), ""))['$include?'](" ") : $a))) {
              reftext = reftext.$squeeze(" ").$strip();}          if ($truthy(reftext['$include?']("\""))) {
              reftext = reftext.$gsub("\"", "&quot;");}          return "" + (attrs) + " xreflabel=\"" + (reftext) + "\"";
          } else {
            return attrs
        ...
        Opal.def(self, '$author_tag', $DocBook5Converter_author_tag$51 = function $$author_tag(doc, author) {
          ...
          if ($truthy(author.$firstname())) {
            result['$<<']("" + "<firstname>" + (doc.$sub_replacements(author.$firstname())) + "</firstname>");}        if ($truthy(author.$middlename())) {
            result['$<<']("" + "<othername>" + (doc.$sub_replacements(author.$middlename())) + "</othername>");}        if ($truthy(author.$lastname())) {
            result['$<<']("" + "<surname>" + (doc.$sub_replacements(author.$lastname())) + "</surname>");}        result['$<<']("</personname>");
          if ($truthy(author.$email())) {
            result['$<<']("" + "<email>" + (author.$email()) + "</email>");}        result['$<<']("</author>");
          return result.$join($$($nesting, 'LF'));
        ...
        Opal.def(self, '$document_info_tag', $DocBook5Converter_document_info_tag$52 = function $$document_info_tag(doc) {
          ...
          result = ["<info>"];
          if ($truthy(doc.$notitle())) ; else if ($truthy((title = doc.$doctitle($hash2(["partition", "use_fallback"], {"partition": true, "use_fallback": true})))['$subtitle?']())) {
            ...
            result['$<<']("" + "<date>" + (date) + "</date>");}        if ($truthy(doc['$attr?']("copyright"))) {
            
            $$($nesting, 'CopyrightRx')['$=~'](doc.$attr("copyright"));
            result['$<<']("<copyright>");
            result['$<<']("" + "<holder>" + ((($a = $gvars['~']) === nil ? nil : $a['$[]'](1))) + "</holder>");
            if ($truthy((($a = $gvars['~']) === nil ? nil : $a['$[]'](2)))) {
              result['$<<']("" + "<year>" + ((($a = $gvars['~']) === nil ? nil : $a['$[]'](2))) + "</year>");}          result['$<<']("</copyright>");}        if ($truthy(doc['$header?']())) {
            
            if ($truthy((authors = doc.$authors())['$empty?']())) ; else if ($truthy($rb_gt(authors.$size(), 1))) {
              ...
              if ($truthy(author.$initials())) {
                result['$<<']("" + "<authorinitials>" + (author.$initials()) + "</authorinitials>");}          }          if ($truthy(($truthy($a = doc['$attr?']("revdate")) ? ($truthy($b = doc['$attr?']("revnumber")) ? $b : doc['$attr?']("revremark")) : $a))) {
              
              result['$<<']("" + "<revhistory>\n" + "<revision>");
              if ($truthy(doc['$attr?']("revnumber"))) {
                result['$<<']("" + "<revnumber>" + (doc.$attr("revnumber")) + "</revnumber>");}            if ($truthy(doc['$attr?']("revdate"))) {
                result['$<<']("" + "<date>" + (doc.$attr("revdate")) + "</date>");}            if ($truthy(doc['$attr?']("authorinitials"))) {
                result['$<<']("" + "<authorinitials>" + (doc.$attr("authorinitials")) + "</authorinitials>");}            if ($truthy(doc['$attr?']("revremark"))) {
                result['$<<']("" + "<revremark>" + (doc.$attr("revremark")) + "</revremark>");}            result['$<<']("" + "</revision>\n" + "</revhistory>");}          if ($truthy(($truthy($a = doc['$attr?']("front-cover-image")) ? $a : doc['$attr?']("back-cover-image")))) {
              if ($truthy((back_cover_tag = self.$cover_tag(doc, "back")))) {
                ...
                result['$<<'](front_cover_tag);}}          if ($truthy(doc['$attr?']("orgname"))) {
              result['$<<']("" + "<orgname>" + (doc.$attr("orgname")) + "</orgname>");}          if ($truthy((docinfo_content = doc.$docinfo())['$empty?']())) ; else {
              result['$<<'](docinfo_content);
            }}        result['$<<']("</info>");
          if (doc.$doctype()['$==']("manpage")) {
            ...
            if ($truthy(doc['$attr?']("mantitle"))) {
              result['$<<']("" + "<refentrytitle>" + (doc.$attr("mantitle")) + "</refentrytitle>");}          if ($truthy(doc['$attr?']("manvolnum"))) {
              result['$<<']("" + "<manvolnum>" + (doc.$attr("manvolnum")) + "</manvolnum>");}          result['$<<']("" + "<refmiscinfo class=\"source\">" + (doc.$attr("mansource", "&#160;")) + "</refmiscinfo>");
            ...
            if ($truthy(doc['$attr?']("mannames"))) {
              result = $rb_plus(result, $send(doc.$attr("mannames"), 'map', [], ($$54 = function(n){var self = $$54.$$s || this;
                ...
                if (n == null) {
                  n = nil;
                }              return "" + "<refname>" + (n) + "</refname>";}, $$54.$$s = self, $$54.$$arity = 1, $$54)));}          if ($truthy(doc['$attr?']("manpurpose"))) {
              result['$<<']("" + "<refpurpose>" + (doc.$attr("manpurpose")) + "</refpurpose>");}          result['$<<']("</refnamediv>");}        return result.$join($$($nesting, 'LF'));
        ...
        Opal.def(self, '$blockquote_tag', $DocBook5Converter_blockquote_tag$58 = function $$blockquote_tag(node, tag_name) {
          ...
          if ($truthy(node['$title?']())) {
            result['$<<']("" + "<title>" + (node.$title()) + "</title>");}        if ($truthy(($truthy($a = node['$attr?']("attribution")) ? $a : node['$attr?']("citetitle")))) {
            
            result['$<<']("<attribution>");
            if ($truthy(node['$attr?']("attribution"))) {
              result['$<<'](node.$attr("attribution"));}          if ($truthy(node['$attr?']("citetitle"))) {
              result['$<<']("" + "<citetitle>" + (node.$attr("citetitle")) + "</citetitle>");}          result['$<<']("</attribution>");}        result['$<<'](Opal.yieldX($yield, []));
          result['$<<'](end_tag);
          return result.$join($$($nesting, 'LF'));
