  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.defn(self, '$document', TMP_DocBook5Converter_document_1 = function $$document(node) {
        ...
        return $rb_times(result, Opal.const_get_relative($nesting, 'LF'));
      ...
      Opal.defn(self, '$section', TMP_DocBook5Converter_section_2 = function $$section(node) {
        ...
        if (node.$document().$doctype()['$==']("manpage")) {
          tag_name = ($truthy($a = Opal.const_get_relative($nesting, 'MANPAGE_SECTION_TAGS')['$[]']((tag_name = node.$sectname()))) ? $a : tag_name)
          } else {
...
if (item == null) item = nil;
      ...
      Opal.defn(self, '$table', TMP_DocBook5Converter_table_31 = function $$table(node) {
...
if (cell == null) cell = nil;
      ...
      Opal.defn(self, '$ulist', TMP_DocBook5Converter_ulist_34 = function $$ulist(node) {
...
if (item == null) item = nil;
      ...
      Opal.defn(self, '$verse', TMP_DocBook5Converter_verse_35 = function $$verse(node) {
        var $a, self = this, result = nil;
      ...
      Opal.defn(self, '$inline_anchor', TMP_DocBook5Converter_inline_anchor_36 = function $$inline_anchor(node) {
      ...
      Opal.defn(self, '$inline_break', TMP_DocBook5Converter_inline_break_37 = function $$inline_break(node) {
        var self = this;

        return "" + (node.$text()) + "<?asciidoc-br?>"
      }, TMP_DocBook5Converter_inline_break_37.$$arity = 1);
      
      Opal.defn(self, '$inline_button', TMP_DocBook5Converter_inline_button_38 = function $$inline_button(node) {
        var self = this;

        return "" + "<guibutton>" + (node.$text()) + "</guibutton>"
      }, TMP_DocBook5Converter_inline_button_38.$$arity = 1);
      
      Opal.defn(self, '$inline_callout', TMP_DocBook5Converter_inline_callout_39 = function $$inline_callout(node) {
        var self = this;

        return "" + "<co" + (self.$common_attributes(node.$id())) + "/>"
      }, TMP_DocBook5Converter_inline_callout_39.$$arity = 1);
      
      Opal.defn(self, '$inline_footnote', TMP_DocBook5Converter_inline_footnote_40 = function $$inline_footnote(node) {
        var self = this;
      ...
      Opal.defn(self, '$inline_image', TMP_DocBook5Converter_inline_image_41 = function $$inline_image(node) {
      ...
      Opal.defn(self, '$inline_indexterm', TMP_DocBook5Converter_inline_indexterm_42 = function $$inline_indexterm(node) {
      ...
      Opal.defn(self, '$inline_kbd', TMP_DocBook5Converter_inline_kbd_43 = function $$inline_kbd(node) {
      ...
      Opal.defn(self, '$inline_menu', TMP_DocBook5Converter_inline_menu_44 = function $$inline_menu(node) {
      ...
      Opal.defn(self, '$inline_quoted', TMP_DocBook5Converter_inline_quoted_45 = function $$inline_quoted(node) {
      ...
      Opal.defn(self, '$author_element', TMP_DocBook5Converter_author_element_46 = function $$author_element(doc, index) {
      ...
      Opal.defn(self, '$common_attributes', TMP_DocBook5Converter_common_attributes_47 = function $$common_attributes(id, role, reftext) {
        ...
        if ($truthy(reftext)) {
          ...
          if ($truthy(($truthy($a = reftext['$include?']("<")) ? (reftext = reftext.$gsub(Opal.const_get_relative($nesting, 'XmlSanitizeRx'), ""))['$include?'](" ") : $a))) {
      ...
      Opal.defn(self, '$doctype_declaration', TMP_DocBook5Converter_doctype_declaration_48 = function $$doctype_declaration(root_tag_name) {
        var self = this;

        return nil
      }, TMP_DocBook5Converter_doctype_declaration_48.$$arity = 1);
      
      Opal.defn(self, '$document_info_element', TMP_DocBook5Converter_document_info_element_50 = function $$document_info_element(doc, info_tag_prefix, use_info_tag_prefix) {
...
if (index == null) index = nil;
      ...
      Opal.defn(self, '$document_ns_attributes', TMP_DocBook5Converter_document_ns_attributes_51 = function $$document_ns_attributes(doc) {
        var self = this;
      ...
      Opal.defn(self, '$lang_attribute_name', TMP_DocBook5Converter_lang_attribute_name_52 = function $$lang_attribute_name() {
        var self = this;

        return "xml:lang"
      }, TMP_DocBook5Converter_lang_attribute_name_52.$$arity = 0);
      
      Opal.defn(self, '$document_title_tags', TMP_DocBook5Converter_document_title_tags_53 = function $$document_title_tags(title) {
        var self = this;
      ...
      Opal.defn(self, '$resolve_content', TMP_DocBook5Converter_resolve_content_54 = function $$resolve_content(node) {
        var self = this;
      ...
      Opal.defn(self, '$title_tag', TMP_DocBook5Converter_title_tag_55 = function $$title_tag(node, optional) {
        var $a, self = this;
      ...
      return (Opal.defn(self, '$cover_tag', TMP_DocBook5Converter_cover_tag_56 = function $$cover_tag(doc, face, use_placeholder) {
        ...
        if ($truthy((cover_image = doc.$attr("" + (face) + "-cover-image")))) {
          ...
          width_attr = nil;
          depth_attr = nil;
          if ($truthy(($truthy($a = cover_image['$include?'](":")) ? Opal.const_get_relative($nesting, 'ImageMacroRx')['$=~'](cover_image) : $a))) {
            
            cover_image = doc.$image_uri((($a = $gvars['~']) === nil ? nil : $a['$[]'](1)));
            if ($truthy((($a = $gvars['~']) === nil ? nil : $a['$[]'](2))['$empty?']())) {
              } else {
              
              attrs = Opal.const_get_relative($nesting, 'AttributeList').$new((($a = $gvars['~']) === nil ? nil : $a['$[]'](2))).$parse(["alt", "width", "height"]);
